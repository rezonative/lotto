...
if($nadpisuj){
	$zapytanie = "UPDATE Lotto SET uppdate='".$uppdate."', zestaw1='".$zestaw1."', zestaw2='".$zestaw2."', zestaw3='".$zestaw3."', zestaw4='".$zestaw4."' WHERE losowanie=".$losowanie;
}
else{
	$zapytanie = "INSERT INTO Lotto(uppdate,losowanie,zestaw1,zestaw2,zestaw3,zestaw4) VALUES ('".$uppdate."','".$losowanie."','".$zestaw1."','".$zestaw2."','".$zestaw3."','".$zestaw4."');";
}
